...
class Mailer
{
    ...
    public function sendPurchaseReceipt($toEmail, $orderId, $cartItems, $totalAmount, $downloadLinks)
    {
        try {
            ...
            $this->mail->addAddress($toEmail);
            $this->mail->isHTML(true);
            $this->mail->Subject = "Purchase Receipt - Order #$orderId";
            ...
            $linksHtml = '';
            foreach ($downloadLinks as $link) {
                $linksHtml .= "<li style='margin-bottom: 8px;'><a href='{$link}' target='_blank' style='color: #0066cc; text-decoration: none;'>Download File</a></li>";
            }
            ...
            // Email body
            $this->mail->Body = "
                <div style='font-family: Arial, sans-serif; max-width: 700px; margin: auto; background: #ffffff; border: 1px solid #ddd;'>
                    
                    <!-- Header -->
                    <div style='padding: 20px; border-bottom: 1px solid #ddd;'>
                        <h2 style='margin: 0; font-size: 20px; color: #333;'>Purchase Receipt</h2>
                        <p style='margin: 5px 0 0; font-size: 14px; color: #666;'>Order #{$orderId} | {$orderDate}</p>
                    </div>
        
                    <!-- Product Table -->
                    <div style='padding: 20px;'>
                        <h3 style='margin-top: 0; font-size: 16px; color: #333; border-bottom: 1px solid #ddd; padding-bottom: 8px;'>Product Information</h3>
                        ...
                        <p style='text-align: right; font-size: 16px; margin-top: 15px;'><strong>Total Paid: {$totalFormatted}</strong></p>
        
                        <!-- Download Links -->
                        <h3 style='margin-top: 30px; font-size: 16px; color: #333; border-bottom: 1px solid #ddd; padding-bottom: 8px;'>Download Links (Login Required)</h3>
                        ...
                        <div style='margin-top: 20px;'>
                            <a href='https://digitalsdesign.com/user' target='_blank' style='background: #0066cc; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 4px; font-size: 14px;'>Visit Your Dashboard</a>
                        </div>
        
                        <!-- Closing Message -->
                        <div style='text-align: center; margin: 40px 0 20px;'>
                            <p style='margin: 0 0 20px; color: #666; font-size: 16px; line-height: 1.6;'>
                                We hope you enjoy your digital products!
                            </p>
                            <p style='margin: 0; font-size: 16px; color: #333;'>
                                Warm regards,<br>
                                <strong style='color: #333;'>The DigitalsDesign.com Team</strong>
                            </p>
                        </div>
